...
export function Dashboard({onOpenDepositModal,onOpenBorrowModal, provider,WETHData,DaiData,SBLData,totalDepositBalance,totalBorrowBalance,maxCollateralFactor,currentHealthFactor}:DashboardProps ){
